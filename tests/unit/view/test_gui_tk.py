...
class TestView:
    ...
    def test_structure(self, mocked_vm_variables_data):
    ...
    def test_get_var_method(self, mocked_vm_variables_data):
        with view_module.View(mocked_vm_variables_data) as view:

            assert view.get_var('shape').get() == 'round'

    def test_rewrite_method(self, mocked_vm_variables_data):
        with view_module.View(mocked_vm_variables_data) as view:
...
class TestWidgets:
    ...
    def test_entry(self, mocked_vm_variables_data):
        with view_module.View(mocked_vm_variables_data) as root:
            test_id = 'test_id'
            test_value = 'test_value'
